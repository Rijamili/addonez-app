...
const { createTenant, updateTenant, deleteTenant, addUser, removeUser, listTenants, debugUserFields, debugProductFields, debugModuleSearch, debugActionInfo, debugModelSearch, debugMenuSearch, debugCustomModules, debugModuleModels, debugStudioModels, debugCompanyFilterTest, debugDatabaseCheck, debugModelRules } = require("../controllers/adminController");
...
router.get("/debug/studio-models", requireSuperAdminOrOwnTenantAdmin, debugStudioModels);

router.get("/debug/company-filter-test", requireSuperAdminOrOwnTenantAdmin, debugCompanyFilterTest);

router.get("/debug/database-check", requireSuperAdminOrOwnTenantAdmin, debugDatabaseCheck);

router.get("/debug/model-rules", requireSuperAdminOrOwnTenantAdmin, debugModelRules);
